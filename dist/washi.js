var Washi = (function(n) {
  ...
  function(n, t, e) {
    var r = e(17),
      ...
      i = function() {
        ...
        return (
          r.extend.apply(null, [n].concat(r.toArray(arguments))),
          (n.el = r.query(o(n, 'el', document.body))),
          (n.$el = r(n.el)),
          r.mapEvents(n.el, o(n, 'events'), o(n, 'ui'), n),
          (n.ui = u(n.el, o(n, 'ui'))),
          (n.$ = r(n.el)),
          o(n, 'initialize'),
          n
  ...
  function(n) {
    function t(n, t, e, r) {
      return (
        !n.addEventListener && (t = 'on' + t),
        (n.addEventListener || n.attachEvent)(t, e, r),
        e
      )
    }
    function e(n, t, e, r) {
      return (
        !n.removeEventListener && (t = 'on' + t),
        (n.removeEventListener || n.detachEvent)(t, e, r),
        e
      )
    }
